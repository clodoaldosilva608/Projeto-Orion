...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Fábrica", href: "/fabrica", icon: Factory },
      { label: "Projetos", href: "/fabrica/projetos", icon: FolderKanban },
      { label: "Briefings", href: "/fabrica/briefings", icon: ClipboardList },
  ...
  {
    title: "Módulos de Vendas (Extras)",
    items: [
      { label: "Metas", href: "/metas", icon: Trophy },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Widgets Dashboard", href: "/dashboard-widgets", icon: LayoutGrid },
      { label: "Integrações ERP", href: "/integracoes", icon: Plug },
